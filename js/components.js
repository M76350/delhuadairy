        ...
        <div>
          ...
          <div class="footer-contact-list">
            ...
            <div class="footer-contact-row">
              ...
              <a href="tel:+917635065908" class="footer-contact-text footer-tel">+91 76350 65908</a>
            </div>
            <div class="footer-contact-row">
              <div class="footer-contact-icon"><i class="fab fa-whatsapp" aria-hidden="true"></i></div>
              <a href="https://wa.me/917635065908" class="footer-contact-text footer-tel" target="_blank" rel="noopener">WhatsApp: +91 76350 65908</a>
            </div>
            <div class="footer-contact-row">
          ...
          <div class="footer-social" role="list" aria-label="Social Media Links">
            ...
            <a href="https://wa.me/917635065908" class="social-icon" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer" role="listitem"><i class="fab fa-whatsapp" aria-hidden="true"></i></a>
...
<!-- WhatsApp Float -->
<a href="https://wa.me/917635065908" class="whatsapp-float" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp par sampark karein">
